...
if (project.hasProperty("useKsp")) {
    ...
    extensions.configure<org.jetbrains.kotlin.gradle.plugin.KaptExtension> {
        ...
        arguments {
            arg("multiPreviewType", "com.vinaygaba.showkase_browser_testing_submodule.two.LocalePreview")
            arg("multiPreviewType", "com.vinaygaba.showkase_browser_testing_submodule.two.EnglishLocalePreview")
            arg("skipPrivatePreviews", "true")
        }
    }
}
